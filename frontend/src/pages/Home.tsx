...
/**
 * Pre-shell layout restored: always-visible hero UI shot + copy + CTAs.
 * Score knobs (GleamAI/FlashCore): system-ui H1, optional fonts in index.html,
 * content-visibility on below-fold, deferred toasters in App.
 */
const Home = () => {
  return (
